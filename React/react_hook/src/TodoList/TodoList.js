...
export const TodoList = () => {
    ...
    return (
        <div style={{ display: "grid", gridTemplateColumns: "300px 300px", justifyContent: "center" }}>
            <div>
                <h3>TodoList</h3>
                <ul style={{ listStyle: "none" }}>
                    {list.map((text, index) => <li>{text}<span onClick={() => handleDone()}><img src={arrow} style={{ width: "15px" }} /></span></li>)}
                </ul>
                <div>
